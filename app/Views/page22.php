...
body{
    ...
    font-family: "db_chuanpim_psu_bd","db_chuanpim_psu_regular","db_chuanpim_psu_it";
    width: 100vw;
    height: 100vh;
}
...
@font-face {
  ...
  src: url('./font/Chuanpim/db_chuanpim_psu_regular.ttf');
}

@font-face {
  font-family: db_chuanpim_psu_it;
  src: url('./font/Chuanpim/db_chuanpim_psu_it.ttf');
}

@font-face {
  font-family: db_chuanpim_psu_bd;
  src: url('./font/Chuanpim/db_chuanpim_psu_bd.ttf');
}
...
.top-footer {
    ...
    padding-bottom: 8rem;
    padding-top: 2rem;
    font-family: "db_chuanpim_psu_bd","db_chuanpim_psu_regular","db_chuanpim_psu_it",sans-serif;
  }
...
<?php } ?>
    ...
    <div id="pic2" style="width:100%;">
      ...
      ทีมนักวิจัย มหาวิทยาลัยสงขลานครินทร์ สาขาวิชาวิศวกรรมไฟฟ้า โดย ดร.กิตติคุณ
      </div>
    </div>
    <hr>
<?php } ?>
